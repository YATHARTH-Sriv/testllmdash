  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card className="dark:bg-black dark:text-slate-100">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 dark:border-slate-700">
      ...
      <Card className="dark:bg-black dark:text-slate-100">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 dark:border-slate-700">
          <CardTitle className="text-sm font-medium">LLM Drift Rate</CardTitle>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
